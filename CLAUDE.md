...
```bash
node scripts/build-modular.mjs && node scripts/check-theme-tokens.mjs && node scripts/test-llm.mjs && node scripts/test-agent.mjs && node scripts/test-metadata.mjs && node scripts/test-danbooru.mjs && node scripts/test-flow.mjs && node scripts/test-content.mjs && node scripts/test-import.mjs && node scripts/test-build.mjs
```
